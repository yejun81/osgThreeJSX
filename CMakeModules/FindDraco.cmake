...
find_path(draco_INCLUDE_DIRS NAMES "${draco_version_file_no_prefix}"
  PATHS ${ACTUAL_3RDPARTY_DIR}/draco/release/include
)
...
#   PATHS ${ACTUAL_3RDPARTY_DIR}/draco/release/lib
#   )
# else()
  find_library(draco_LIBRARIES_DEBUG NAMES draco.lib libdraco.a
  PATHS ${ACTUAL_3RDPARTY_DIR}/draco/debug/lib
  )
